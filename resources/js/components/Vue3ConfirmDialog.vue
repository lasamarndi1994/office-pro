<template>
    <transition name="fade">
        ...
        <div v-if="isOpen" @click="handleClickOverlay" class="vc-overlay" id="vueConfirm">

            <transition name="zoom">

                <div v-if="isOpen" ref="vueConfirmDialog" class="vc-container">
                    ...
                    <div class="vc-btn-grid" :class="{ isMono: !dialog.button.no || !dialog.button.yes }">
                        <button v-if="dialog.button.no" @click.stop="emit('modal-close')" class="vc-btn left"
                            type="button">
                            {{ dialog.button.no }}
                        </button>
