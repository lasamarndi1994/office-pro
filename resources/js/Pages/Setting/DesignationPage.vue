<template>
    <app-layout>
            ...
            <div class="modal-dialog modal-md  modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="departmentModalLabel">Add Designations</h5>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="input-block mb-3">
                                        <div>
                                            <mwc-textfield class="w-100" label="Designation Name *" outlined
                                                id="designation_name"></mwc-textfield>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="d-flex justify-content-between">
            <div>
                <h2 class="font-monospace text-expanded text-uppercase fs-6">Designations</h2>
            </div>
            <div>
                <button class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#exampleModal" type="button"><i
                        class="material-icons">
                        add
                    </i>Add Designations</button>
            </div>
        </div>
