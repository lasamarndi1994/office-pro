                ...
                <form>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-6">
                                <div class="input-block mb-3">
                                    <mwc-textfield  class="w-100" label="Available Balance" outlined disabled></mwc-textfield>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="input-block mb-3">
                                   
                                    <mwc-textfield v-model="formData.email" class="w-100" label="From Date" outlined id="filled"></mwc-textfield>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="input-block mb-3">
                            ...
                            <div class="col-sm-12">
                                <div class="input-block mb-3">
                                    <mwc-textfield class="w-100" label="Search Employee" outlined icon="person"></mwc-textfield>
                                </div>
                            </div>
                        </div>
                    </form>
                        ...
                        <tbody>
                            <tr v-for="i in 5">
                                ...
                                <div class="dropdown dropdown-action">
                                    ...
                                    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#edit_leave"><span class="material-icons m-r-5">
                                    edit
                                    </span> Edit</a>
                                    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#delete_approve"><span class="material-icons m-r-5">
                                    delete
                                    </span>
                                    Delete</a>
                                    </div>
...
const formData = ref({
    ...
    onMounted(() => {
        window.filled.addEventListener('change', function () {
            formData.name = window.filled.value;
